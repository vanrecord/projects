                            ...
                            <div class="overflow-hidden border rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        <tr v-for="(item,key) in shops.data">
                                            ...
                                            <td class="text-sm text-gray-800 whitespace-nowrap">
                                                <div class="float-left">
                                                    <button @click="showDetail(item)" class="px-3 py-0 rounded-lg">
                                            	...
                                            	<div class="float-left ">
                                            		<Link :href="route('shop.edit',item.id)" class=" rounded-lg">
                                            	...
                                            	<div class="float-left">
                                            		<button @click="destroy(item.id)" class="px-3 py-0  rounded-lg">
